...
module top ;
	...
	wire [0:0] tmpOE__Echo_rechts_net;
	wire [0:0] tmpIO_0__Echo_rechts_net;
	wire [0:0] tmpINTERRUPT_0__Echo_rechts_net;
	electrical [0:0] tmpSIOVREF__Echo_rechts_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		Echo_rechts
		 (.oe(tmpOE__Echo_rechts_net),
		  .y({1'b0}),
		  .fb({Net_101}),
		  .io({tmpIO_0__Echo_rechts_net[0:0]}),
		  .siovref(tmpSIOVREF__Echo_rechts_net),
		  .interrupt({tmpINTERRUPT_0__Echo_rechts_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Echo_rechts_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
    ...
    TCPWM_P4_v2_10_3 UltraSoon_Midden (
        .stop(Net_83),
        .reload(Net_83),
        .start(Net_83),
        .count(1'b1),
	...
	wire [0:0] tmpOE__Echo_Links_net;
	wire [0:0] tmpIO_0__Echo_Links_net;
	wire [0:0] tmpINTERRUPT_0__Echo_Links_net;
	electrical [0:0] tmpSIOVREF__Echo_Links_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("d79d121a-c6f0-4cd3-a002-1f4018bf2321"),
		  ...
		  .input_buffer_sel(2'b00))
		Echo_Links
		 (.oe(tmpOE__Echo_Links_net),
		  .y({1'b0}),
		  .fb({Net_91}),
		  .io({tmpIO_0__Echo_Links_net[0:0]}),
		  .siovref(tmpSIOVREF__Echo_Links_net),
		  .interrupt({tmpINTERRUPT_0__Echo_Links_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Echo_Links_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    TCPWM_P4_v2_10_4 UltraSoon_Rechts (
        .stop(Net_91),
        .reload(Net_91),
        .start(Net_91),
        .count(1'b1),
	...
	wire [0:0] tmpOE__Echo_Midden_net;
	wire [0:0] tmpIO_0__Echo_Midden_net;
	wire [0:0] tmpINTERRUPT_0__Echo_Midden_net;
	electrical [0:0] tmpSIOVREF__Echo_Midden_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("299a869b-09ab-474d-a4c6-0e446e5f5e59"),
		  ...
		  .input_buffer_sel(2'b00))
		Echo_Midden
		 (.oe(tmpOE__Echo_Midden_net),
		  .y({1'b0}),
		  .fb({Net_83}),
		  .io({tmpIO_0__Echo_Midden_net[0:0]}),
		  .siovref(tmpSIOVREF__Echo_Midden_net),
		  .interrupt({tmpINTERRUPT_0__Echo_Midden_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Echo_Midden_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
