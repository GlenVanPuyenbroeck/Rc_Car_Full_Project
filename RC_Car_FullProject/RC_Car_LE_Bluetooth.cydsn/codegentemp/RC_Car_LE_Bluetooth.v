// ======================================================================
// RC_Car_LE_Bluetooth.v generated from TopDesign.cysch
// 10/28/2020 at 17:12
...
// TCPWM_P4_v2_10(Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, PinVisibility_index=false, PinVisibility_kill=false, PinVisibility_phiA=false, PinVisibility_phiB=false, PinVisibility_switch=false, PWMCompare=65535, PWMCompareBuf=65535, PWMCompareSwap=0, PWMCountMode=2, PWMCountPresent=true, PWMDeadTimeCycle=0, PWMInterruptMask=1, PWMKillEvent=0, PWMLinenSignal=0, PWMLineSignal=0, PWMMode=4, PWMPeriod=65535, PWMPeriodBuf=65535, PWMPeriodSwap=0, PWMPrescaler=0, PWMReloadMode=0, PWMReloadPresent=false, PWMRunMode=0, PWMSetAlign=0, PWMStartMode=0, PWMStartPresent=false, PWMStopEvent=0, PWMStopMode=0, PWMStopPresent=false, PWMSwitchMode=0, PWMSwitchPresent=false, QuadAutoStart=true, QuadEncodingModes=0, QuadIndexMode=0, QuadIndexPresent=false, QuadInterruptMask=1, QuadPhiAMode=3, QuadPhiBMode=3, QuadStopMode=0, QuadStopPresent=false, TCCaptureMode=1, TCCapturePresent=true, TCCompare=65535, TCCompareBuf=65535, TCCompareSwap=0, TCCompCapMode=2, TCCountingModes=0, TCCountMode=3, TCCountPresent=false, TCInterruptMask=2, TCPeriod=65535, TCPrescaler=0, TCPWMCapturePresent=false, TCPWMConfig=1, TCPWMCountPresent=false, TCPWMReloadPresent=false, TCPWMStartPresent=false, TCPWMStopPresent=false, TCReloadMode=0, TCReloadPresent=true, TCRunMode=0, TCStartMode=0, TCStartPresent=true, TCStopMode=1, TCStopPresent=true, TermMode_capture=0, TermMode_cc=0, TermMode_clock=0, TermMode_count=0, TermMode_interrupt=0, TermMode_line=0, TermMode_line_n=0, TermMode_ov=0, TermMode_reload=0, TermMode_start=0, TermMode_stop=0, TermMode_un=0, TermModeStates=, TermVisibility_capture=true, TermVisibility_cc=true, TermVisibility_clock=true, TermVisibility_count=false, TermVisibility_interrupt=true, TermVisibility_line=false, TermVisibility_line_n=false, TermVisibility_ov=true, TermVisibility_reload=true, TermVisibility_start=true, TermVisibility_stop=true, TermVisibility_un=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_P4_v2_10, CY_CONFIG_TITLE=UltraSoon_Midden, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=UltraSoon_Midden, CY_INSTANCE_SHORT_NAME=UltraSoon_Midden, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=UltraSoon_Midden, )
...
// TCPWM_P4_v2_10(Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, PinVisibility_index=false, PinVisibility_kill=false, PinVisibility_phiA=false, PinVisibility_phiB=false, PinVisibility_switch=false, PWMCompare=65535, PWMCompareBuf=65535, PWMCompareSwap=0, PWMCountMode=2, PWMCountPresent=true, PWMDeadTimeCycle=0, PWMInterruptMask=1, PWMKillEvent=0, PWMLinenSignal=0, PWMLineSignal=0, PWMMode=4, PWMPeriod=65535, PWMPeriodBuf=65535, PWMPeriodSwap=0, PWMPrescaler=0, PWMReloadMode=0, PWMReloadPresent=false, PWMRunMode=0, PWMSetAlign=0, PWMStartMode=0, PWMStartPresent=false, PWMStopEvent=0, PWMStopMode=0, PWMStopPresent=false, PWMSwitchMode=0, PWMSwitchPresent=false, QuadAutoStart=true, QuadEncodingModes=0, QuadIndexMode=0, QuadIndexPresent=false, QuadInterruptMask=1, QuadPhiAMode=3, QuadPhiBMode=3, QuadStopMode=0, QuadStopPresent=false, TCCaptureMode=1, TCCapturePresent=true, TCCompare=65535, TCCompareBuf=65535, TCCompareSwap=0, TCCompCapMode=2, TCCountingModes=0, TCCountMode=3, TCCountPresent=false, TCInterruptMask=2, TCPeriod=65535, TCPrescaler=0, TCPWMCapturePresent=false, TCPWMConfig=1, TCPWMCountPresent=false, TCPWMReloadPresent=false, TCPWMStartPresent=false, TCPWMStopPresent=false, TCReloadMode=0, TCReloadPresent=true, TCRunMode=0, TCStartMode=0, TCStartPresent=true, TCStopMode=1, TCStopPresent=true, TermMode_capture=0, TermMode_cc=0, TermMode_clock=0, TermMode_count=0, TermMode_interrupt=0, TermMode_line=0, TermMode_line_n=0, TermMode_ov=0, TermMode_reload=0, TermMode_start=0, TermMode_stop=0, TermMode_un=0, TermModeStates=, TermVisibility_capture=true, TermVisibility_cc=true, TermVisibility_clock=true, TermVisibility_count=false, TermVisibility_interrupt=true, TermVisibility_line=false, TermVisibility_line_n=false, TermVisibility_ov=true, TermVisibility_reload=true, TermVisibility_start=true, TermVisibility_stop=true, TermVisibility_un=true, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=TCPWM_P4_v2_10, CY_CONFIG_TITLE=UltraSoon_Rechts, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=UltraSoon_Rechts, CY_INSTANCE_SHORT_NAME=UltraSoon_Rechts, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=UltraSoon_Rechts, )
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=false, Compare1_8=true, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=127, CompareValue2=63, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG8, CySetRegReplacementString=CY_SET_REG8, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=255, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg8, RegSizeReplacementString=uint8, Resolution=8, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=false, UDB8=true, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP8, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONFIG_TITLE=Motor_Links, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Motor_Links, CY_INSTANCE_SHORT_NAME=Motor_Links, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=Motor_Links, )
module PWM_v3_30_7 (
    reset,
    clock,
    tc,
...
module top ;
    ...
    TCPWM_P4_v2_10_1 UltraSoon_Links (
        .stop(Net_101),
        .reload(Net_101),
        .start(Net_101),
        .count(1'b1),
	...
	wire [0:0] tmpOE__Trigger_Midden_net;
	wire [0:0] tmpFB_0__Trigger_Midden_net;
	wire [0:0] tmpIO_0__Trigger_Midden_net;
	wire [0:0] tmpINTERRUPT_0__Trigger_Midden_net;
	electrical [0:0] tmpSIOVREF__Trigger_Midden_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Trigger_Midden
		 (.oe(tmpOE__Trigger_Midden_net),
		  .y({Net_466}),
		  .fb({tmpFB_0__Trigger_Midden_net[0:0]}),
		  .io({tmpIO_0__Trigger_Midden_net[0:0]}),
		  .siovref(tmpSIOVREF__Trigger_Midden_net),
		  .interrupt({tmpINTERRUPT_0__Trigger_Midden_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Trigger_Midden_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    TCPWM_P4_v2_10_2 UltraSoon_Midden (
        .stop(Net_83),
        .reload(Net_83),
        .start(Net_83),
        .count(1'b1),
	...
	cy_psoc3_pins_v1_10
		#(.id("d79d121a-c6f0-4cd3-a002-1f4018bf2321"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    TCPWM_P4_v2_10_3 UltraSoon_Rechts (
        .stop(Net_91),
        .reload(Net_91),
        .start(Net_91),
        .count(1'b1),
	...
	wire [0:0] tmpOE__Echo_M_net;
	wire [0:0] tmpIO_0__Echo_M_net;
	wire [0:0] tmpINTERRUPT_0__Echo_M_net;
	electrical [0:0] tmpSIOVREF__Echo_M_net;

	cy_psoc3_pins_v1_10
		#(.id("299a869b-09ab-474d-a4c6-0e446e5f5e59"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Echo_M
		 (.oe(tmpOE__Echo_M_net),
		  .y({1'b0}),
		  .fb({Net_83}),
		  .io({tmpIO_0__Echo_M_net[0:0]}),
		  .siovref(tmpSIOVREF__Echo_M_net),
		  .interrupt({tmpINTERRUPT_0__Echo_M_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Echo_M_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Trigger_Rechts_net;
	wire [0:0] tmpFB_0__Trigger_Rechts_net;
	wire [0:0] tmpIO_0__Trigger_Rechts_net;
	wire [0:0] tmpINTERRUPT_0__Trigger_Rechts_net;
	electrical [0:0] tmpSIOVREF__Trigger_Rechts_net;

	cy_psoc3_pins_v1_10
		#(.id("819607a1-e7f7-490d-9800-97d3f3c1fad2"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Trigger_Rechts
		 (.oe(tmpOE__Trigger_Rechts_net),
		  .y({Net_466}),
		  .fb({tmpFB_0__Trigger_Rechts_net[0:0]}),
		  .io({tmpIO_0__Trigger_Rechts_net[0:0]}),
		  .siovref(tmpSIOVREF__Trigger_Rechts_net),
		  .interrupt({tmpINTERRUPT_0__Trigger_Rechts_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Trigger_Rechts_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Trigger_Links_net;
	wire [0:0] tmpFB_0__Trigger_Links_net;
	wire [0:0] tmpIO_0__Trigger_Links_net;
	wire [0:0] tmpINTERRUPT_0__Trigger_Links_net;
	electrical [0:0] tmpSIOVREF__Trigger_Links_net;

	cy_psoc3_pins_v1_10
		#(.id("1ea03a96-7218-4280-a800-fad25c86ccb3"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Trigger_Links
		 (.oe(tmpOE__Trigger_Links_net),
		  .y({Net_466}),
		  .fb({tmpFB_0__Trigger_Links_net[0:0]}),
		  .io({tmpIO_0__Trigger_Links_net[0:0]}),
		  .siovref(tmpSIOVREF__Trigger_Links_net),
		  .interrupt({tmpINTERRUPT_0__Trigger_Links_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Trigger_Links_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__T_Motor_R_Groen_net;
	wire [0:0] tmpFB_0__T_Motor_R_Groen_net;
	wire [0:0] tmpIO_0__T_Motor_R_Groen_net;
	wire [0:0] tmpINTERRUPT_0__T_Motor_R_Groen_net;
	electrical [0:0] tmpSIOVREF__T_Motor_R_Groen_net;

	cy_psoc3_pins_v1_10
		#(.id("470c6ace-d56e-4479-8fac-34e5b612764f"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		T_Motor_R_Groen
		 (.oe(tmpOE__T_Motor_R_Groen_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__T_Motor_R_Groen_net[0:0]}),
		  .io({tmpIO_0__T_Motor_R_Groen_net[0:0]}),
		  .siovref(tmpSIOVREF__T_Motor_R_Groen_net),
		  .interrupt({tmpINTERRUPT_0__T_Motor_R_Groen_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__T_Motor_R_Groen_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__T_Motor_R_Geel_net;
	wire [0:0] tmpFB_0__T_Motor_R_Geel_net;
	wire [0:0] tmpIO_0__T_Motor_R_Geel_net;
	wire [0:0] tmpINTERRUPT_0__T_Motor_R_Geel_net;
	electrical [0:0] tmpSIOVREF__T_Motor_R_Geel_net;

	cy_psoc3_pins_v1_10
		#(.id("1a4d14b7-83a9-4858-943b-c201d033c43c"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		T_Motor_R_Geel
		 (.oe(tmpOE__T_Motor_R_Geel_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__T_Motor_R_Geel_net[0:0]}),
		  .io({tmpIO_0__T_Motor_R_Geel_net[0:0]}),
		  .siovref(tmpSIOVREF__T_Motor_R_Geel_net),
		  .interrupt({tmpINTERRUPT_0__T_Motor_R_Geel_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__T_Motor_R_Geel_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__T_Motor_R_Rood_net;
	wire [0:0] tmpFB_0__T_Motor_R_Rood_net;
	wire [0:0] tmpIO_0__T_Motor_R_Rood_net;
	wire [0:0] tmpINTERRUPT_0__T_Motor_R_Rood_net;
	electrical [0:0] tmpSIOVREF__T_Motor_R_Rood_net;

	cy_psoc3_pins_v1_10
		#(.id("0e7ba302-8f7b-4a8d-b18f-e1f4fac184db"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		T_Motor_R_Rood
		 (.oe(tmpOE__T_Motor_R_Rood_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__T_Motor_R_Rood_net[0:0]}),
		  .io({tmpIO_0__T_Motor_R_Rood_net[0:0]}),
		  .siovref(tmpSIOVREF__T_Motor_R_Rood_net),
		  .interrupt({tmpINTERRUPT_0__T_Motor_R_Rood_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__T_Motor_R_Rood_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__T_Motor_L_Groen_net;
	wire [0:0] tmpFB_0__T_Motor_L_Groen_net;
	wire [0:0] tmpIO_0__T_Motor_L_Groen_net;
	wire [0:0] tmpINTERRUPT_0__T_Motor_L_Groen_net;
	electrical [0:0] tmpSIOVREF__T_Motor_L_Groen_net;

	cy_psoc3_pins_v1_10
		#(.id("7564c6c3-7b55-4446-b090-7c3a5686ba98"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		T_Motor_L_Groen
		 (.oe(tmpOE__T_Motor_L_Groen_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__T_Motor_L_Groen_net[0:0]}),
		  .io({tmpIO_0__T_Motor_L_Groen_net[0:0]}),
		  .siovref(tmpSIOVREF__T_Motor_L_Groen_net),
		  .interrupt({tmpINTERRUPT_0__T_Motor_L_Groen_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__T_Motor_L_Groen_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__T_Motor_L_Geel_net;
	wire [0:0] tmpFB_0__T_Motor_L_Geel_net;
	wire [0:0] tmpIO_0__T_Motor_L_Geel_net;
	wire [0:0] tmpINTERRUPT_0__T_Motor_L_Geel_net;
	electrical [0:0] tmpSIOVREF__T_Motor_L_Geel_net;

	cy_psoc3_pins_v1_10
		#(.id("b0f8fa16-9264-48d8-9996-62c81ee13acb"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		T_Motor_L_Geel
		 (.oe(tmpOE__T_Motor_L_Geel_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__T_Motor_L_Geel_net[0:0]}),
		  .io({tmpIO_0__T_Motor_L_Geel_net[0:0]}),
		  .siovref(tmpSIOVREF__T_Motor_L_Geel_net),
		  .interrupt({tmpINTERRUPT_0__T_Motor_L_Geel_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__T_Motor_L_Geel_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__T_Motor_L_Rood_net;
	wire [0:0] tmpFB_0__T_Motor_L_Rood_net;
	wire [0:0] tmpIO_0__T_Motor_L_Rood_net;
	wire [0:0] tmpINTERRUPT_0__T_Motor_L_Rood_net;
	electrical [0:0] tmpSIOVREF__T_Motor_L_Rood_net;

	cy_psoc3_pins_v1_10
		#(.id("aa62121a-9b8c-4251-ad8c-bc85093a4342"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		T_Motor_L_Rood
		 (.oe(tmpOE__T_Motor_L_Rood_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__T_Motor_L_Rood_net[0:0]}),
		  .io({tmpIO_0__T_Motor_L_Rood_net[0:0]}),
		  .siovref(tmpSIOVREF__T_Motor_L_Rood_net),
		  .interrupt({tmpINTERRUPT_0__T_Motor_L_Rood_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__T_Motor_L_Rood_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    PWM_v3_30_6 Motor_Rechts (
        .reset(1'b0),
        .clock(Net_1030),
        .tc(Net_1003),
        .pwm1(Net_1004),
        ...
        .ph1(Net_1013),
        .ph2(Net_1014));
    defparam Motor_Rechts.Resolution = 8;

    PWM_v3_30_7 Motor_Links (
        .reset(1'b0),
        .clock(Net_1030),
        .tc(Net_1031),
        .pwm1(Net_1032),
        ...
        .ph1(Net_1041),
        .ph2(Net_1042));
    defparam Motor_Links.Resolution = 8;
	...
	wire [0:0] tmpOE__To_Motor_L_net;
	wire [0:0] tmpFB_0__To_Motor_L_net;
	wire [0:0] tmpIO_0__To_Motor_L_net;
	wire [0:0] tmpINTERRUPT_0__To_Motor_L_net;
	electrical [0:0] tmpSIOVREF__To_Motor_L_net;

	cy_psoc3_pins_v1_10
		#(.id("c2314ea5-e98a-4840-a49a-7336cbe60a08"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		To_Motor_L
		 (.oe(tmpOE__To_Motor_L_net),
		  .y({Net_1040}),
		  .fb({tmpFB_0__To_Motor_L_net[0:0]}),
		  .io({tmpIO_0__To_Motor_L_net[0:0]}),
		  .siovref(tmpSIOVREF__To_Motor_L_net),
		  .interrupt({tmpINTERRUPT_0__To_Motor_L_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__To_Motor_L_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__To_Motor_R_net;
	wire [0:0] tmpFB_0__To_Motor_R_net;
	wire [0:0] tmpIO_0__To_Motor_R_net;
	wire [0:0] tmpINTERRUPT_0__To_Motor_R_net;
	electrical [0:0] tmpSIOVREF__To_Motor_R_net;

	cy_psoc3_pins_v1_10
		#(.id("5748e8cb-b7b6-4706-a4bc-a670b463fe8a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		To_Motor_R
		 (.oe(tmpOE__To_Motor_R_net),
		  .y({Net_1012}),
		  .fb({tmpFB_0__To_Motor_R_net[0:0]}),
		  .io({tmpIO_0__To_Motor_R_net[0:0]}),
		  .siovref(tmpSIOVREF__To_Motor_R_net),
		  .interrupt({tmpINTERRUPT_0__To_Motor_R_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__To_Motor_R_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
